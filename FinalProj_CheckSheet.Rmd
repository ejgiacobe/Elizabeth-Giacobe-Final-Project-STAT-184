...
(A) .Rmd Line numbers where at least two different data sources are imported: 27, 42, 57, 71  


(B) .Rmd Line numbers for inspecting data intake: 35, 50, 65, 77, 85  
...
(A) .Rmd Line number(s) for general data wrangling: 213  


(B) .Rmd Line number(s) for a join operation: 228, 237, 247  


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 162  


(D) .Rmd Line number(s) for use of regular expressions: 216  


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 266  
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 284  
...
(A) .Rmd Line number(s) for use of mulitple different geoms: n/a  

(B) .Rmd Line number(s) for use of multiple aesthetics: 303  

(C) .Rmd Line number(s) for use of layered graphics: 302  

(D) .Rmd Line number(s) for use of leaflet maps: n/a  

(E) .Rmd Line number(s) for use of decision tree or dendogram results: 310      
